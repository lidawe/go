...
func encode(a obj.As) *inst {
	...
	//C910
	case AMULA:
		return &inst{0xb, 0x1, 0x0, 0, 0x10}
	case AMULAH:
		return &inst{0xb, 0x1, 0x0, 0, 0x14}
	case AMULAW:
		return &inst{0xb, 0x1, 0x0, 0, 0x12}
	case AMULS:
		return &inst{0xb, 0x1, 0x0, 0, 0x11}
	case AMULSH:
		return &inst{0xb, 0x1, 0x0, 0, 0x15}
	case AMULSW:
		return &inst{0xb, 0x1, 0x0, 0, 0x13}
	case ASRRI:
		return &inst{0xb, 0x1, 0x0, 256, 0x4}
	case AREV:
		return &inst{0xb, 0x1, 0x0, 0, 0x41}
		//case AMVEQZ:
		//return &inst{0xb, 0x1, 0x0, 0, 0x20}
	case ATLRB:
		return &inst{0xb, 0x4, 0x0, 0, 0x0}
	case ATLRBU:
		return &inst{0xb, 0x4, 0x0, 0, 0x40}
	case ATLRH:
		return &inst{0xb, 0x4, 0x0, 0, 0x10}
	case ATLRHU:
		return &inst{0xb, 0x4, 0x0, 0, 0x50}
	case ATLRW:
		return &inst{0xb, 0x4, 0x0, 0, 0x20}
	case ATLRWU:
		return &inst{0xb, 0x4, 0x0, 0, 0x60}
	case ATLRD:
		return &inst{0xb, 0x4, 0x0, 0, 0x30}
	}
	return nil
}
